...
class AddGameFirestoreUseCase @Inject constructor(private val firebaseFirestore: FirebaseFirestore) {
    fun invoke(gameSlug:String,email:String) {
        ...
        docRef.update(FIRESTORE_USER_GAME_DIRECTORY, FieldValue.arrayUnion(gameSlug))
    }
}